"""
=============================================================================
SCRIPT NAME: Step Fourteen T2 GDELT Combined Target Optimization.py
=============================================================================

INPUT FILES (T2 + GDELT Combined track):
- T2_GDELT_Combined_Final_Country_Weights.xlsx (All Periods)
...
OUTPUT FILES:
- T2_GDELT_Combined_Optimized_Country_Weights.xlsx
- T2_GDELT_Combined_Optimized_Strategy_Analysis.pdf
- T2_GDELT_Combined_Turnover_Analysis.pdf
- T2_GDELT_Combined_Weighted_Average_Factor_Exposure.pdf
- T2_GDELT_Combined_Weighted_Average_Factor_Rolling_Analysis.pdf
...
def load_data():
    ...
    target_weights_file = 'T2_GDELT_Combined_Final_Country_Weights.xlsx'
    ...
    alphas_file = 'T2_GDELT_Combined_Country_Alphas.xlsx'
    ...
    exposure_file = 'T2_GDELT_Combined_Top_20_Exposure.csv'
...
def save_results(optimized_weights_df, metrics_df, performance_results_df, comprehensive_stats_df, summary_stats, alphas_df, 
    ...
    """
    output_file = 'T2_GDELT_Combined_Optimized_Country_Weights.xlsx'
...
def create_visualization(performance_results_df, comprehensive_stats_df):
    ...
    fig.suptitle('T2 + GDELT Combined Strategy Optimization: Comprehensive Performance Analysis', fontsize=16)
    ...
    output_file = 'T2_GDELT_Combined_Optimized_Strategy_Analysis.pdf'
    ...
    turnover_file = 'T2_GDELT_Combined_Turnover_Analysis.pdf'
...
Max: {diff_max:+.4f}"""
    ...
    # Save the plot
    output_file = 'T2_GDELT_Combined_Weighted_Average_Factor_Exposure.pdf'
    plt.savefig(output_file, dpi=300, bbox_inches='tight')
    plt.close()
    ...
    rolling_output_file = 'T2_GDELT_Combined_Weighted_Average_Factor_Rolling_Analysis.pdf'
...
def main():
    ...
    logging.info("="*80)
    logging.info("T2+GDELT COMBINED TRACK - STEP FOURTEEN: TARGET OPTIMIZATION")
    logging.info("="*80)
