...
# Define input files
top20_file = 'GDELT Top20.xlsx'
optimizer_file = 'GDELT_Optimizer.xlsx'
factor_weights_file = 'GDELT_rolling_window_weights.xlsx'
country_weights_file = 'GDELT_Final_Country_Weights.xlsx'
portfolio_returns_file = 'GDELT_Final_Portfolio_Returns.xlsx'
strategy_stats_file = 'GDELT_strategy_statistics.xlsx'

# Output report file
output_file = f'GDELT_Strategy_Report_Comprehensive_{report_date}.pdf'

class PDF(FPDF):
    def header(self):
        # Title
        self.set_font('Arial', 'B', 18)  
        self.cell(0, 10, 'GDELT Strategy Report - Comprehensive', 0, 1, 'C')
...
def create_comprehensive_report():
    """
    Generate the comprehensive GDELT strategy report with all sections from both versions.
    """
    print("Generating Comprehensive GDELT Strategy Report...")
    ...
    pdf.cell(0, 20, 'GDELT Strategy Report', 0, 1, 'C')
    ...
    pdf.set_font('Arial', '', 12)
    pdf.multi_cell(0, 5, 'The following table shows the top 10 portfolios from our GDELT Top20 analysis.')
    ...
    pdf.set_font('Arial', '', 12)
    pdf.multi_cell(0, 5, 'Analysis of the latest factor weights for the GDELT strategy.')
    ...
    try:
        ...
        if len(sample_weights) == 0:
            ...
            pdf.ln(5)
            pdf.set_font('Arial', 'I', 9)
            pdf.multi_cell(0, 5, 'Source: GDELT Factor Weight Analysis - Full Period')
            ...
            if len(recent_sample_weights) > 0:
                ...
                pdf.ln(5)
                pdf.set_font('Arial', 'I', 9)
                pdf.multi_cell(0, 5, 'Source: GDELT Factor Weight Analysis - Recent 3 Years')
            else:
                pdf.set_font('Arial', '', 11)
    ...
    pdf.set_font('Arial', '', 12)
    pdf.multi_cell(0, 5, 'Current country weights for the GDELT strategy portfolio.')
    ...
    summary_text = f"""
This comprehensive GDELT Strategy Report contains detailed analysis across 8 key sections:
...
This report provides comprehensive insights into the GDELT strategy performance,
...
def generate_report_with_options():
    ...
    """
    print("=" * 60)
    print("GDELT Strategy Report Generator - Comprehensive Version 2.1")
    print("=" * 60)
