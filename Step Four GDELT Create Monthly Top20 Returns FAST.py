...
def save_net_returns_to_excel(net_returns: Dict[str, pd.Series], output_path: str):
    ...
    with pd.ExcelWriter("GDELT_T60.xlsx", engine="xlsxwriter") as writer:
    ...
    print(f"GDELT_Optimizer.xlsx saved to {output_path}")
...
def save_trading_costs_to_excel(trading_costs: Dict[str, pd.Series], output_path: str):
    ...
    print(f"GDELT_Trading_Cost.xlsx saved to {output_path}")
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "GDELT_Optimizer.xlsx"
    TRADING_COST_OUTPUT_PATH = "GDELT_Trading_Cost.xlsx"
