...
"""
=============================================================================
SCRIPT NAME: Step Four T2 GDELT Combined Top3 Returns FAST.py
=============================================================================
...
OUTPUT FILES:
- T2_GDELT_Combined_Top3_Optimizer.xlsx  (Monthly_Net_Returns)
- T2_GDELT_Combined_Top3_T60.xlsx       (T60)
- T2_GDELT_Combined_Top3_Trading_Cost.xlsx
...
value and equal-weight them (1/3 each).  Calculate net excess returns (portfolio
minus benchmark), trading costs, and the 60-month rolling average (T60).

Mirrors Step Four T2 GDELT Combined Create Monthly Top20 Returns FAST.py but
replaces the soft 15–25% band with a hard top-3 selection.

USAGE:
  python "Step Four T2 GDELT Combined Top3 Returns FAST.py"
=============================================================================
"""
...
OUTPUT_OPTIMIZER = "T2_GDELT_Combined_Top3_Optimizer.xlsx"
OUTPUT_T60 = "T2_GDELT_Combined_Top3_T60.xlsx"
OUTPUT_TRADING_COST = "T2_GDELT_Combined_Top3_Trading_Cost.xlsx"
...
def analyze_portfolios(
    ...
    for feature in features:
        ...
        for date in feature_dates:
            ...
            returns_filtered = return_values[:k]
            countries_filtered = data_countries[:k]

            portfolio_returns[date] = float(np.dot(weights, returns_filtered))
