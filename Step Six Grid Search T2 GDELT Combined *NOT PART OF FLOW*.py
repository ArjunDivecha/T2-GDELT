"""
Factor Timing Strategy Grid Search — T2 + GDELT Combined (not part of main flow)

=============================================================================
INPUT FILES:
- T2_GDELT_Combined_Optimizer.xlsx (default): sheet ``Monthly_Net_Returns`` from
  Step Four T2 GDELT Combined Create Monthly Top20 Returns FAST.py.
  You can set ``OPTIMIZER_PATH`` below to ``T2_GDELT_Combined_Top3_Optimizer.xlsx``
  if you use the Top-3 country pipeline instead.
- Step Factor Categories T2 GDELT Combined.xlsx: columns ``Factor Name`` and ``Max``.
...
WHAT THIS DOES:
Same logic as ``Step Six Grid Search *NOT PART OF FLOW*.py``: grid over
...
# -----------------------------------------------------------------------------
# Paths — edit OPTIMIZER_PATH to switch Top20 vs Top3 combined outputs
# -----------------------------------------------------------------------------
OPTIMIZER_PATH = "T2_GDELT_Combined_Optimizer.xlsx"
# OPTIMIZER_PATH = "T2_GDELT_Combined_Top3_Optimizer.xlsx"

FACTOR_CATEGORIES_PATH = "Step Factor Categories T2 GDELT Combined.xlsx"
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 80)
    print("BEST COMBINATIONS (T2 + GDELT Combined)")
    print("=" * 80)
    print(
